  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in pb-20 px-4 md:px-0 selection:bg-primary selection:text-white">
      ...
      <div className="relative h-[400px] md:h-[500px] rounded-[3.5rem] overflow-hidden mb-32 group shadow-2xl">
        ...
        <div className="absolute -bottom-24 left-0 right-0 px-12 flex flex-col lg:flex-row items-end justify-between gap-10">
           <div className="flex flex-col lg:flex-row items-end gap-10 w-full lg:w-auto">
             ...
             <div className="mb-10 pb-4 text-center lg:text-left space-y-4">
           ...
           <div className="flex items-center gap-5 mb-10">
             {isOwnProfile ? (
               ...
               <>
                 ...
                 <button className="h-16 w-16 rounded-[1.5rem] bg-surface/40 backdrop-blur-xl border border-white/10 flex items-center justify-center hover:border-primary/50 transition-all text-gray-400 hover:text-white hover:-translate-y-1 group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-40">
        ...
        <div className="lg:col-span-8">
           <div className="flex items-center gap-10 mb-12 border-b border-white/5 relative">
             {[
               ...
               { id: 'collections', icon: Folder, label: 'Art Community' },
           ...
           <div className="animate-fade-in">
             ...
             {(tab === 'collections') && (
               <div className="flex flex-col items-center justify-center py-32 bg-dark-card border border-white/5 rounded-[4rem] group">
                 <div className="w-24 h-24 bg-surface rounded-[2rem] flex items-center justify-center mb-10 shadow-inner group-hover:scale-110 transition-transform">
                    <Folder size={48} className="text-gray-700" />
                 </div>
                 <p className="text-gray-500 font-black text-[10px] uppercase tracking-[0.4em]">Art Community is currently locked.</p>
               </div>
             )}
                                 ...
                                 <div className="bg-dark/40 rounded-[3rem] p-10 border border-white/5 shadow-inner space-y-8 relative overflow-hidden group/camera">
                                   ...
                                   {!verificationFiles.passportPhoto && !showCamera && (
                                     <button type="button" onClick={startCamera} className="w-full py-8 rounded-[2rem] bg-surface/40 border border-white/5 hover:border-primary/50 transition-all flex flex-col items-center justify-center gap-4 group/cam-btn">
                                       ...
                                       <span className="text-[11px] font-black uppercase tracking-[0.3em] text-white">Start Camera</span>
                                     </button>
                                   )}
                                   
                                   {showCamera && (
                                     <div className="space-y-8 animate-slide-up">
                                       <div className="relative aspect-video rounded-[2rem] overflow-hidden bg-black shadow-2xl border-2 border-primary/20">
                                         <video ref={videoRef} autoPlay playsInline className="w-full h-full object-cover"/>
                                         <div className="absolute inset-0 pointer-events-none border-[40px] border-dark/60">
                                            <div className="w-full h-full border-2 border-primary/40 border-dashed animate-pulse" />
                                         </div>
                                         <canvas ref={canvasRef} className="hidden"/>
                                       </div>
                                       <div className="flex gap-6">
                                         <button type="button" onClick={takePhoto} className="flex-1 h-16 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] shadow-2xl shadow-primary/30 hover:scale-[1.02] active:scale-95 transition-all">Execute Capture</button>
                                         <button type="button" onClick={stopCamera} className="px-10 h-16 bg-surface/60 text-gray-400 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] hover:text-white hover:bg-surface transition-all">Cancel</button>
                                       </div>
                                     </div>
                                   )}
