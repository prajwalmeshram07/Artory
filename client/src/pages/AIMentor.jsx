...
import { Send, Bot, User, Sparkles, BookOpen, PlayCircle, Upload, X, ChevronRight, Zap, Target, Award, BrainCircuit, MessageCircle, MoreVertical } from 'lucide-react';
...
export default function AIMentor() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 h-[calc(100vh-10rem)] animate-fade-in px-4 lg:px-0">
      {/* Chat Panel */}
      <div className="flex-1 flex flex-col bg-dark-card border border-dark-border/40 rounded-[2.5rem] overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-dark-border/30 bg-gradient-to-r from-primary/10 via-transparent to-accent/10">
          ...
          <div className="flex items-center gap-2">
            <button className="w-10 h-10 rounded-xl bg-surface/40 flex items-center justify-center text-gray-400 hover:text-white transition-all">
