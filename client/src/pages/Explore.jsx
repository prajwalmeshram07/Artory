      ...
      <div className="flex-shrink-0 z-20 relative space-y-10 mb-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
             ...
             <button className="h-16 px-8 rounded-2xl bg-surface/40 backdrop-blur-xl border border-white/5 text-[11px] font-black uppercase tracking-[0.2em] text-white hover:bg-surface/60 flex items-center gap-3 transition-all hover:border-primary/40 group">
