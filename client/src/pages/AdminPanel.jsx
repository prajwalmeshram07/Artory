...
import { Shield, Users, Image as ImageIcon, Layers, Trash2, FileWarning, BadgeCheck, Trophy, Check, Ban, Activity, AlertTriangle, UserCheck, Zap, MoreVertical, ExternalLink } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-dark-border/40 pb-10">
        ...
        <div className="flex items-center gap-3">
            <div className="text-right">
               <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Administrator Access</p>
               <p className="text-sm font-bold text-white">Lvl 99 Authority</p>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-surface flex items-center justify-center text-gray-400">
