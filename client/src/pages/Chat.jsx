        ...
        {currentSelected ? (
          <>
            ...
            <div className="flex items-center justify-between px-12 py-8 border-b border-white/5 bg-surface/30 backdrop-blur-3xl relative z-10">
              ...
              <div className="flex items-center gap-4">
                 <button className="h-14 w-14 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center text-gray-500 hover:text-primary transition-all hover:border-primary/20 hover:-translate-y-1 group/btn shadow-xl">
                    <ShieldCheck size={24} className="group-hover/btn:scale-110 transition-transform" />
                 </button>
                 <button onClick={() => setShowGroupInfo(!showGroupInfo)} className="h-14 w-14 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center text-gray-500 hover:text-primary transition-all hover:border-primary/20 hover:-translate-y-1 group/btn shadow-xl">
