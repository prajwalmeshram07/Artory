    ...
    <div className="max-w-7xl mx-auto space-y-16 animate-fade-in pb-20 px-4 lg:px-0 selection:bg-primary selection:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
         ...
         <div className="lg:col-span-4 space-y-12">
            ...
            {/* Premium CTA */}
            <div className="bg-gradient-to-br from-primary to-accent rounded-[3.5rem] p-10 text-white shadow-2xl relative overflow-hidden group cursor-pointer hover:shadow-primary/40 transition-all">
               <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity" />
               <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 rounded-full blur-[60px]" />
               
               <Shield size={48} className="mb-8 opacity-40 group-hover:scale-110 transition-transform"/>
               <h3 className="text-3xl font-black mb-3 tracking-tighter">Artory Plus</h3>
               <p className="text-sm opacity-90 font-bold mb-10 leading-relaxed">
                  Upgrade to get high-res art, presets, and mentor tools.
               </p>
               <button className="w-full bg-white text-primary font-black py-5 rounded-2xl text-[11px] uppercase tracking-[0.2em] shadow-2xl hover:scale-105 active:scale-95 transition-all">
                  Evolve Your Status
               </button>
            </div>

            {/* Quick Tips */}
            <div className="bg-dark-card border border-white/5 rounded-[3rem] p-10 space-y-6">
               <h4 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] flex items-center gap-3">
                  <Star size={14} className="text-yellow-400"/> Daily Insight
               </h4>
               <p className="text-sm font-medium text-gray-400 leading-relaxed">
                  "The secret to Neo-Surrealism is the juxtaposition of impossible shadows with hyper-realistic textures."
               </p>
               <div className="flex items-center gap-3 pt-2">
                  <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary">
                     <Bot size={16}/>
                  </div>
                  <span className="text-[10px] font-black text-white uppercase tracking-widest">Master AI Oracle</span>
               </div>
            </div>
         </div>
      </div>
